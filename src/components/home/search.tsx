...
// import { FormSubmit } from '../../lib/utils/interface'
...
//   }
  ...
  return (
    <div className='pb-20 pt-14 px-10 md:px-0'>
      <h1 style={{ lineHeight: '70px' }} className='md:text-5xl text-3xl text-black text-center font-medium mb-7'>Get The <span className='text-[#504ED7]'>Right Job</span> <br className='hidden md:block' /> You Deserve</h1>
